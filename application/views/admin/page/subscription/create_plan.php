					...
					<?=form_open_multipart($action,array('class' => 'subplan-form', 'id' => 'subplan-form'));?>
						<div class="row">
							...
							<div class="col-12 col-sm-4">
								...
								<div class="form-group">
									<textarea name="plan_desc" id="plan_desc" cols="30" rows="10" class="form-control">Add Description here..</textarea>
								</div>
							</div>
							...
							<div class="col-12 col-sm-4">
								...
								<div class="form-group">
									<input type="text" class="form-control" name="resume_time" id="resume_time" required placeholder="Example : 20 min OR 2 Days OR 1 Hour">
								</div>
							</div>
                            ...
                            <div class="col-12 col-sm-4">
								...
								<div class="form-group">
                                <textarea name="plan_notes" id="plan_notes" cols="30" rows="10" class="form-control">Add Notes Here..</textarea>
								</div>
							</div>
							...
							<div class="col-12 col-sm-4">
								...
								<div class="form-group">
									<input type="number" class="form-control" name="no_topics" id="no_topics" required placeholder="Ex: 3 OR 1 OR 2">
								</div>
							</div>
