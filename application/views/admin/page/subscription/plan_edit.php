				...
				<div class="card-body">
					...
					<div class="row">
                            ...
                            <div class="col-12 col-sm-4">
								...
								<div class="form-group">
                                    <select class="form-control select2" required name="plan_type" id="plan_type" required >
                                        <option value="">Select Plan Type</option>
										<?php
										if(!empty($get_plan_type)){
											foreach($get_plan_type as $plan_type){
											?>
											<option value="<?= $plan_type['plan_type_id'];?>" <?php if($plan_type['plan_type_id'] == $editData->plan_type){ echo "selected"; }?>><?= $plan_type['type_name'];?></option>
											<?php
											}
										}
										?>
							...
							<div class="col-12 col-sm-4">
								...
								<div class="form-group">
									<input type="number" class="form-control" name="plan_price" id="plan_price" required placeholder="Enter Plan Price" value="<?= $editData->plan_price;?>">
								</div>
							</div>
							...
							<div class="col-12 col-sm-4">
								...
								<div class="form-group">
									<input type="date" class="form-control" name="start_date" id="start_date" required value="<?php echo $editData->start_date;?>">
								</div>
							</div>
							...
							<div class="col-12 col-sm-4">
								...
								<div class="form-group">
									<input type="date" class="form-control" name="end_date" id="end_date" required value="<?php echo $editData->end_date;?>">
								</div>
							</div>
							...
							<div class="col-12 col-sm-4">
								...
								<div class="form-group">
									<input type="text" class="form-control" name="resume_time" id="resume_time" required placeholder="Example : 20 min OR 2 Days OR 1 Hour" value="<?= $editData->resume_time;?>">
								</div>
							</div>
							...
							<div class="col-12 col-sm-4">
								...
								<div class="form-group">
									<input type="number" class="form-control" name="no_topics" id="no_topics" required placeholder="Ex: 3 OR 1 OR 2" value="<?= $editData->access_no_topics; ?>">
								</div>
							</div>
