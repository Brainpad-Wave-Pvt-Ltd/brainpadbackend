									...
									<div class="jumbotron">
											...
											<div id="question-item-<?= $i ?>" class="d-none">
												<div class="form-row">
													<div class="form-group col-3 d-none q-audio">
														<input type="file" class="form-control" name="qm2files[<?= $i ?>][]" id="qm2img" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
													</div>
													...
													<div class="form-group col-3 q-touch d-none">
														<input type="file" class="form-control" name="touch_audio[<?= $i ?>][]" id="touch-audio" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
													</div>

													<div class="form-group col-3 q-true d-none">
														<input type="file" class="form-control" name="audio[<?= $i ?>][]" id="true-audio" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
													</div>
										...
										<div id="answer">
											...
											<div id="answer-item-<?= $i ?>" class="d-none">
												<div class="form-row">
													<div class="form-group col-3">
														<input type="file" class="form-control" name="ead_img[<?= $i ?>][]" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
													</div>
													...
													<div class="form-group col-3">
														<input type="file" class="form-control" name="ead_touch_audio[<?= $i ?>][]"  id="ead_touch_audio" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
													</div>

													<div class="form-group col-3">
														<input type="file" class="form-control" name="ead_audio[<?= $i ?>][]" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
													</div>
													...
													foreach ($get_answer_data as $key1 => $aiData) { $k++;
														...
														<div class="form-row">
															...
															<div class="form-group col-3">
																...
																<?php } ?>
																<input type="file" class="form-control" name="ead_touch_audio[<?= $i ?>][]" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
															</div>
