				...
				<?= form_open_multipart( $action, array('id' => 'exampleForm')); ?>
					...
					<div class="card-body">
						...
						<div class="form-row">
							...
							<div class="form-group col-4">
								<label>Audio</label>
								<input type="file" class="form-control" name="sound" id="sound" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
							</div>
							<div class="form-group col-4 d-none exp" >
								<label>Example Explanation</label>
								<input type="file" class="form-control" name="explaination" id="explaination" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
							</div>
						</div>
									...
									<div id="question-item-1">
										<div class="form-row">
											<div class="form-group col-3 d-none q-audio">
												<input type="file" class="form-control que-img" name="qm2files[1][]" id="eqd_img" data--disable="eqd_text" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
											</div>
											...
											<div class="form-group col-3 q-touch d-none" >
												<input type="file" class="form-control" name="touch_audio[1][]" id="eqd_touch_audio" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
											</div>

											<div class="form-group col-3 q-true d-none">
												<input type="file" class="form-control" name="audio[1][]" id="eqd_audio" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
											</div>
									...
									<div id="answer-item-1">
										<div class="form-row">
											<div class="form-group col-3 a-audio d-none" >
												<input type="file" class="form-control ans-img" name="ead_img[1][]"  id="ead_img" data--disable="ead_text" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
											</div>
											<div class="form-group col-3">
											...
											<div class="form-group col-3 a-touch d-none">
												<input type="file" class="form-control" name="ead_touch_audio[1][]" id="ead_touch_audio" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
											</div>
											<div class="form-group col-3 a-true d-none">
												<input type="file" class="form-control" name="ead_audio[1][]" id="ead_audio" accept="audio/*,image/jpeg,image/png,.jpeg,.jpg,.png">
											</div>
					...
					<div class="card-footer text-right pt-0">
						<div class="form-group">
							<span id="add-remove-card-btn">
								<button type="button" class="btn btn-sm btn-success add-card d-none" id="add-que"><i class="fa fa-plus-circle"></i>  Add Card</button>
								<button type="button" class="btn btn-sm btn-danger d-none remove-card" id="remove-card" onclick="removeRow('sorting_field','que-ans')"><i class="fa fa-minus-circle"></i> Remove Card</button>
							</span>
