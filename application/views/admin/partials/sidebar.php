...
<div class="main-sidebar">
    ...
    margin-top: -5%;">
		...
		<ul class="sidebar-menu">
			...
			<li class="menu-header">Monetization Manager</li>
            
            <li class="<?= ($this->uri->segment('2') == 'subscription_plans') ? 'active' : '' ?>"><a class="nav-link" href="<?= base_url('backend/subscription_plans'); ?>"><i class="fas fa-th-list"></i> <span>Make Subscription</span></a></li>
			
			
            <li class="<?= ($this->uri->segment('2') == 'school') ? 'active' : '' ?>"><a class="nav-link" href="<?= base_url('backend/school'); ?>"><i class="fas fa-list"></i> <span>Add Schools</span></a></li>
			...
			<!-- <li class="<?= ($this->uri->segment('2') == 'plan_type') ? 'active' : '' ?>"><a class="nav-link" href="<?= base_url('backend/plan_type'); ?>"><i class="fas fa-th-list"></i> <span>Plan Types (not needed)</span></a></li> -->
			...
			<li class="<?= ($this->uri->segment('2') == 'teacherlist') ? 'active' : '' ?>"><a class="nav-link" href="<?= base_url('backend/teacherlist'); ?>"><i class="fas fa-users"></i><span>Teacher List</span></a></li>
