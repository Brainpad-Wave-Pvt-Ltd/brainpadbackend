...
class Subscription_plans extends CI_Controller
{
	...
	public function store(){
		$this->db->insert('subscription_plans',[
			...
			'resume_time'   => $this->input->post('resume_time'),
			'plan_notes'    => $this->input->post('plan_notes'),
			'access_no_topics' => $this->input->post('no_topics'),
	...
	public function update($id){
		...
		$data['resume_time']   = $this->input->post('resume_time');
		$data['plan_notes']    = $this->input->post('plan_notes');
		$data['access_no_topics'] = $this->input->post('no_topics');
